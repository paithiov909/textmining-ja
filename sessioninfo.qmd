...
- **2026-03-24**
  - R-4.5.3を使ってビルドしなおしました
- **2025-10-05**
  - [paithiov909/textvis-recipes: Cookbook to draw KHCoder-like visualizations using R](https://github.com/paithiov909/textvis-recipes)の内容をこのサイトのAppendicesとして統合しました
